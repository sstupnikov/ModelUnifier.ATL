...
public class Synthesis2AMNWithExternalProperties {
	...
	public Synthesis2AMNWithExternalProperties(String propertiesPath, String inMetamodelName, String outMetamodelName) throws IOException {
	...
	public void doAtlTransformation(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
		...
		synthesis2amnLauncher.addInModel(inModel, "IN", this.inMetamodelName);
		synthesis2amnLauncher.addOutModel(outModel, "OUT", this.outMetamodelName);
		...
		amn2textLauncher.addInModel(outModel, "IN", this.outMetamodelName);
